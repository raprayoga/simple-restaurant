...
import CashierOrderList from '@/components/modules/CashierOrderList'
...
export default function Cashier({ table, setTable }: CashierProps) {
  return (
    <DefaultLayout>
      <h1 className="mb-5 text-3xl font-bold text-primary">Kasir</h1>
      <div className="flex">
        ...
        <div className="w-5/12 pl-5">
          ...
          <CashierOrderList table={table} className="mt-10" />
        </div>
      </div>
    </DefaultLayout>
  )
